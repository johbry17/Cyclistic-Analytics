...
Google again provided the [template](https://docs.google.com/document/d/1TzCqk59_J23D5zNCvwAPSgK-5osp-wVnifsc-VOpCaI/template/preview?usp=sharing) to clean the data (very helpful of them, making it rather easy to skip straight to analysis). See `data_cleaning_v1_2019q1_2020q1.R`.

I slightly modified the script to clean individual quarters of Cyclistic data. Google's template covered only Q1 2019 and Q1 2020. I wanted to have 2019's Q2, Q3, and Q4 available.

Data cleaning consisted of:

● Removing some columns to match the 2019 and 2020 datasets (Trip duration, gender, and birth year from 2019, station latitude and longitude from 2020). Note: gender and birth year might be fruitful avenues of exploration for data analysis, and I could probably reconstruct and then map out every station from 2020's lat/long data.
