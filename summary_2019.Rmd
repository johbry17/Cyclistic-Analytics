...
Google provided a starter [template](https://github.com/johbry17/Cyclistic-Analytics/blob/main/resources/data_cleaning_v1.R) to clean the data, initially covering only Q1 2019 and Q1 2020. This template was significantly modified to clean all of 2019. [See full data cleaning script](https://github.com/johbry17/Cyclistic-Analytics/blob/main/resources/data_cleaning_v2.R).
...
<p>
  ...
  Further insights are available in the [exploratory data analysis](scratch_pad_2019.html).
</p>
...
Following is the entire setup for the scenario, quoted from the Google Data Analytics Capstone (see PDF [here](https://github.com/johbry17/Cyclistic/blob/main/resources/Case%20Study%201_How%20does%20a%20bike-share%20navigate%20speedy%20success.pdf)):
