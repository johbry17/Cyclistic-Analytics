...
# ggsave("./images/rides_per_day.png", plot = p)
# 
...
#   geom_col(position = "dodge") +
#   theme(legend.position = "bottom", axis.text.x = element_text(angle = 90, hjust = 1))
# ggsave("./images/average_duration.png", plot = p)
...
# write.csv(counts, file = './data/avg_ride_length_v2.csv')
write.csv(q1_2019_cleaned, file = './data/q1_2019_cleaned.csv')
write.csv(q2_2019_cleaned, file = './data/q2_2019_cleaned.csv')
write.csv(q3_2019_cleaned, file = './data/q3_2019_cleaned.csv')
write.csv(q4_2019_cleaned, file = './data/q4_2019_cleaned.csv')
write.csv(q1_2020_cleaned, file = './data/q1_2020_cleaned.csv')
write.csv(stations_2020, file = './data/stations.csv')
