...
● Switched mapping to leaflet heatmaps. Lat/lng coordinates switched from 2019's exact station location to a more granular exact bike location, refelctive of the increase in electric bike usage.
