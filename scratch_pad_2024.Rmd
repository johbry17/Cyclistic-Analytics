...
Bar chart and mapping top start and end stations, casual and member, origin and destination - skipping NA's, the largest category
...
The prior leafleat heatmaps are a sample of 50,000. Something went wrong, though, with the filter, as both maps are exactly the same.
