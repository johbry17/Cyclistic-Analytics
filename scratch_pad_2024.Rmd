...
plot_leaflet_heatmap <- function(data, title) {
  # Compute density (counts per unique lat/lng combination)
  density_data <- data %>%
    count(end_lng, end_lat)
...
plot_leaflet_heatmap(electric, "Electric Bike Trips Heatmap")
plot_leaflet_heatmap(classic, "Classic Bike Trips Heatmap")
plot_leaflet_heatmap(member, "Member Trips Heatmap")
plot_leaflet_heatmap(casual, "Casual Trips Heatmap")
```
